...
get_prop(small_male, 7)


#Normality test - change to total number of observation (42 in the male dataset)

prop_vec_Q1_small_male <- get_prop(small_male, 7)
shapiro.test(prop_vec_Q1_small_male)
...
n1 <- nrow(small_male)
n2 <- nrow(small_male)
Q1_p1_hat <- (sum(small_male$click_1yes_0no == "1"))/n1 #number of edges in the given graph 
Q1_p2_hat <- mean(prop_vec_Q1_small_male) #mean of proportions vector 
