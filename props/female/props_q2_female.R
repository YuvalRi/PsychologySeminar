...
get_prop_directed(Clicks_sorted_women, 10)


#Normality test

prop_vec_Q2_female <- get_prop_directed(Clicks_sorted_women, 10)
shapiro.test(prop_vec_Q2_female)
...
Q2_p1_hat <- (sum(Clicks_sorted_women$click0no1yes == "1"))/n1 #number of edges in the given graph 
Q2_p2_hat <- mean(prop_vec_Q2_female)
