...
sim_res_3 <- sim_3_diff(small_female, 6)

# saving simulation results in excel file
library(rio)
export(sim_res_3, "sim_3_diff_q3_small_females.xlsx")
...
diff_data_q3_small_females <- read_csv("C://Users//yuval//OneDrive//english folder//Seminar - clicks//datasets created by simulations//diff//sim_3_diff_q3_small_females.csv")

# adding column - mean of the differences of each row

diff_data_q3_small_females$mean <- rowMeans(diff_data_q3_small_females, na.rm=TRUE)

# histogram
diff_hist_q3_small_female <- ggplot(diff_data_q3_small_females,
                                 aes(x= mean)
) +
...
diff_hist_q3_small_female


#pvalue
pvalue(diff_data_q3_small_females, mean(as.numeric(diff_rates(small_female, 6))))
