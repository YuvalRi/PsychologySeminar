...
# histogram
diff_hist_q2_45_female <- ggplot(diff_data_q2_45_females,
                                 aes(x= mean)
) +
  ...
  geom_text(x=6.1,
            y=0.25,
            label="6") + 
  coord_cartesian(ylim = c(0, 0.3), xlim = c(5, 12)) +
  theme(legend.position = "none") +
  ggtitle("Frequency of differences in the shuffle") 
diff_hist_q2_45_female


#pvalue
pvalue(diff_data_q2_45_females, mean(as.numeric(diff_rates(females_45, 10))))
