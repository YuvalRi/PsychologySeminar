...
# subject's clicks
neighbors_directed(small_female,1)
neighbors_directed(small_female,2)
neighbors_directed(small_female,3)
neighbors_directed(small_female,4)
neighbors_directed(small_female,5)
neighbors_directed(small_female,6)
