...
transitivity(females_45_graph,vids = V(females_45_graph), type = c("local"))
...
trans = data.frame(Vertex = vertex_names(females_45_graph),
                   Transitivity = transitivity(females_45_graph, type = 'local', vids = V(females_45_graph)))
